...
let SignupComponent = class SignupComponent {
    constructor(formBuilder, router, authService, toast) {
    ...
    create() {
        ...
        this.authService.submitTweet(message, source).subscribe((res) => {
            if (res.status == true) {
...
/* harmony import */ var angular4_paystack__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! angular4-paystack */ "./node_modules/angular4-paystack/fesm2015/angular4-paystack.js");
/* harmony import */ var ngx_print__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ngx-print */ "./node_modules/ngx-print/fesm2015/ngx-print.js");
...
let UserAuthService = class UserAuthService {
    constructor(httpClient) {
        ...
        this.apiServer = 'http://localhost:4000';
    ...
    gettransactionId(id) {
        ...
        return this
            .httpClient
            .get(this.apiServer + `/transaction/transact/` + this.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(data => data));
    }
    // to fetch each Users data by Id
    gettransaction(id) {
        this.id = localStorage.userid;
